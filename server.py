            ...
            if s200 is not None and p_s20 is not None and p_s50 is not None and s20 is not None and s50 is not None:
                if c_price > s200 and p_s20 <= p_s50 and s20 > s50:
                    signals.append({
                        ...
                        'title': 'Swing Momentum Entry',
                        'description': '20 SMA crossed above 50 SMA while price is above 200 SMA',
                        'price': c_price,
                        'sma20': s20,
                        'sma50': s50,
                        'sma200': s200
            ...
            if p_s50 is not None and p_s200 is not None and s50 is not None and s200 is not None:
                if p_s50 <= p_s200 and s50 > s200:
                    signals.append({
                        ...
                        'title': 'Golden Cross Entry',
                        'description': '50-day SMA crossed above 200-day SMA (Major Bullish Trend)',
                        'price': c_price,
                        'sma20': s20,
                        'sma50': s50,
                        'sma200': s200
                ...
                if s20 > s50 and s50 > s200:
                    if p_close <= p_s50 and c_price > s20:
                        signals.append({
                            ...
                            'title': 'Pullback Bounce Entry',
                            'description': 'Tested 50 SMA support and closed above 20 SMA in bull alignment',
                            'price': c_price,
                            'sma20': s20,
                            'sma50': s50,
                            'sma200': s200
